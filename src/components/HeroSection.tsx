...
const HeroSection = () => (
  <section className="relative overflow-hidden bg-navy">
    <div className="absolute inset-0">
      <img src={heroImg} alt="Modern dental treatment room at Smile Avenue Dental Clinic" className="w-full h-full object-cover opacity-30" />
    ...
    <div className="container relative z-10 py-20 md:py-32 lg:py-40">
      <div className="max-w-2xl space-y-6">
        ...
        <p className="text-lg text-navy-foreground/75 max-w-xl">
          Trusted by families across Mysuru for painless, advanced dental treatments. From routine cleanings to cosmetic transformations — your smile is in safe hands at Smile Avenue.
        </p>
